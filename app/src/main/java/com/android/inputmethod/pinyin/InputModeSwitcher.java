...
public class InputModeSwitcher {
   ...
   * shift
   */
  private static final int USERDEF_KEYCODE_1 = -1;

  /**
   * "en中"
   */
  private static final int USERDEF_KEYCODE_2 = -2;

  /**
   * "abc"
   */
  private static final int USERDEF_KEYCODE_3 = -3;

  /**
   * "123"
   */
  private static final int USERDEF_KEYCODE_4 = -4;

  /**
   * "+-="
   */
  private static final int USERDEF_KEYCODE_5 = -5;
   ...
   */
  public static final int MODE_SKB_SYMBOL1 = MASK_SKB_LAYOUT_SYMBOL1;
  ...
  public int switchModeForUserKey(int userKey) {
    ...
    env.setKeyHeight(0);
    if (USERDEF_KEYCODE_3 == userKey) {
      newInputMode = mRecentLauageInputMode;
    } else if (USERDEF_KEYCODE_1 == userKey) {
    ...
    } else if (USERDEF_KEYCODE_2 == userKey) {
    ...
    } else if (USERDEF_KEYCODE_4 == userKey) {
      env.setKeyHeight(1);
      newInputMode = MODE_SKB_PHONE_NUM;
    } else if (USERDEF_KEYCODE_5 == userKey) {
      newInputMode = MODE_SKB_SYMBOL1;
    }
...
//    }
  ...
  private void saveInputMode(int newInputMode) {
    ...
    if (mInputMode == MODE_SKB_CHINESE || mInputMode == MODE_SKB_ENGLISH_LOWER || mInputMode == MODE_SKB_ENGLISH_UPPER) {
