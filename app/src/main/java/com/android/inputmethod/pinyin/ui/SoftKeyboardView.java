...
public class SoftKeyboardView extends View {
  ...
  public SoftKey onKeyPress(int x, int y, SkbContainer.LongPressTimer longPressTimer,
    ...
    if (mSoftKeyDown.needBalloon()) {
      ...
      if (5 == mSoftKeyDown.mKeyType.mKeyTypeId) {
        textSize = env.getBalloonPhoneTextSize();
      } else {
  ...
  @Override protected void onDraw(Canvas canvas) {
    ...
    mNormalPhoneKeyTextSize = env.getPhoneKeyTextSize(false);
    mFunctionPhoneKeyTextSize = env.getPhoneKeyTextSize(true);
    ...
    for (int row = 0; row < rowNum; row++) {
      ...
      for (int i = 0; i < keyNum; i++) {
        ...
        } else if (5 == softKey.mKeyType.mKeyTypeId) {
          mPaint.setTextSize(mNormalPhoneKeyTextSize);
        } else if (6 == softKey.mKeyType.mKeyTypeId || 8 == softKey.mKeyType.mKeyTypeId) {
          mPaint.setTextSize(mFunctionPhoneKeyTextSize);
        } else {
